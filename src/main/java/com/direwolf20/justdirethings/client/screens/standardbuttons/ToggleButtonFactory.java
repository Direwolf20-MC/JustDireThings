...
public class ToggleButtonFactory {
    public record TextureLocalization(Identifier texture, MutableComponent localization) {
    }
    ...
    private static final List<TextureLocalization> REDSTONE_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstoneignore.png"), Component.translatable("justdirethings.screen.ignored")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonelow.png"), Component.translatable("justdirethings.screen.low")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonehigh.png"), Component.translatable("justdirethings.screen.high")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonepulse.png"), Component.translatable("justdirethings.screen.pulse"))
    );
    ...
    private static final List<TextureLocalization> ALLOW_LIST_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/allowlistfalse.png"), Component.translatable("justdirethings.screen.denylist")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/allowlisttrue.png"), Component.translatable("justdirethings.screen.allowlist"))
    );
    ...
    private static final List<TextureLocalization> PUSH_PULL_FLUIDS_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/pullfluids.png"), Component.translatable("justdirethings.screen.pullfluids")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/pushfluids.png"), Component.translatable("justdirethings.screen.pushfluids"))
    );
    ...
    private static final Identifier STORE_EXP_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/add.png");
    ...
    private static final Identifier OWNER_ONLY_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/player.png");
    ...
    private static final Identifier COLLECT_EXP_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/mindfog.png");
    ...
    private static final Identifier RESPECTPICKUP_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/jumpboost.png");
    ...
    private static final Identifier EXTRACT_EXP_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/remove.png");
    ...
    private static final Identifier FILTER_ONLY = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/allowlisttrue.png");
    ...
    private static final Identifier COMPARE_NBT = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/matchnbttrue.png");
    ...
    private static final Identifier COMPARE_COUNTS = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/equals.png");
    ...
    private static final Identifier RENDER_AREA = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/area.png");
    ...
    private static final Identifier RENDER_PARADOX = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/showfakeplayer.png");
    ...
    private static final List<TextureLocalization> DIRECTION_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-down.png"), Component.translatable("justdirethings.screen.direction-down")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-up.png"), Component.translatable("justdirethings.screen.direction-up")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-north.png"), Component.translatable("justdirethings.screen.direction-north")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-south.png"), Component.translatable("justdirethings.screen.direction-south")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-west.png"), Component.translatable("justdirethings.screen.direction-west")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-east.png"), Component.translatable("justdirethings.screen.direction-east"))
    );
    ...
    private static final List<TextureLocalization> DIRECTION_NONE_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-none.png"), Component.translatable("justdirethings.screen.direction-none")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-down.png"), Component.translatable("justdirethings.screen.direction-down")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-up.png"), Component.translatable("justdirethings.screen.direction-up")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-north.png"), Component.translatable("justdirethings.screen.direction-north")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/direction-south.png"), Component.translatable("justdirethings.screen.direction-south")),
    ...
    private static final List<TextureLocalization> FILTERBLOCKITEM_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.filter-block")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-item.png"), Component.translatable("justdirethings.screen.filter-item"))
    );
    ...
    private static final List<TextureLocalization> HAMMER_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/ignore.png"), Component.translatable("justdirethings.ability.hammer_off")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/hammer3.png"), Component.translatable("justdirethings.ability.hammer_3")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/hammer5.png"), Component.translatable("justdirethings.ability.hammer_5")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/hammer7.png"), Component.translatable("justdirethings.ability.hammer_7"))
    );
    ...
    private static final List<TextureLocalization> LEFT_RIGHT_CLICK_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-right.png"), Component.translatable("justdirethings.screen.click-right")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-left.png"), Component.translatable("justdirethings.screen.click-left")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-hold.png"), Component.translatable("justdirethings.screen.click-hold"))
    );
    ...
    private static final List<TextureLocalization> CLICK_TARGET_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.target-block")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-air.png"), Component.translatable("justdirethings.screen.target-air")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.target-passive")),
    ...
    /** Sneak Click button **/
    private static final Identifier SNEAK_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-sneak.png");
    ...
    private static final Identifier SHOWFAKEPLAYER_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/showfakeplayer.png");
    ...
    private static final List<TextureLocalization> PARADOX_TARGET_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/target-both.png"), Component.translatable("justdirethings.screen.paradoxall")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.paradoxblock")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.paradoxentity"))
    );
    ...
    private static final List<TextureLocalization> STRONG_WEAK_REDSTONE_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonelow.png"), Component.translatable("justdirethings.screen.redstone-weak")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonehigh.png"), Component.translatable("justdirethings.screen.redstone-strong"))
    );
    ...
    private static final List<TextureLocalization> EQUALITY_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/greaterthan.png"), Component.translatable("justdirethings.screen.greaterthan")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/lessthan.png"), Component.translatable("justdirethings.screen.lessthan")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/equals.png"), Component.translatable("justdirethings.screen.equals"))
    );
    ...
    private static final Identifier SHOW_PARTICLES_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/showfakeplayer.png");
    ...
    private static final List<TextureLocalization> SWAPPER_ENTITY_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/entity-none.png"), Component.translatable("justdirethings.screen.entity-none")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.target-passive")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/passivemob-adult.png"), Component.translatable("justdirethings.screen.target-adult")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/passivemob-child.png"), Component.translatable("justdirethings.screen.target-child")),
    ...
    private static final List<TextureLocalization> SWAPPER_BLOCK_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.target-block")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/filter-air.png"), Component.translatable("justdirethings.screen.target-noblock"))
    );
    ...
    private static final List<TextureLocalization> LEFT_RIGHT_ONLY_CLICK_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-right.png"), Component.translatable("justdirethings.screen.click-right")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-left.png"), Component.translatable("justdirethings.screen.click-left")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-sneak.png"), Component.translatable("justdirethings.screen.click-custom"))
    );
    ...
    /** Bind Hotkey button **/
    private static final Identifier BIND_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/click-hold.png");
    ...
    private static final List<TextureLocalization> REQUIRE_EQUIPPED_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/requireequipped.png"), Component.translatable("justdirethings.screen.requireequipped")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/notreequireequipped.png"), Component.translatable("justdirethings.screen.notrequireequipped"))
    );
    ...
    private static final List<TextureLocalization> HOMING_TARGET_TEXTURES = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/entity-all.png"), Component.translatable("justdirethings.screen.target-living"))
    );
    ...
    private static final List<TextureLocalization> HIDE_RENDER_BUTTON = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/showfakeplayer.png"), Component.translatable("justdirethings.screen.showrender")),
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/decoy.png"), Component.translatable("justdirethings.screen.hiderender"))
    );
    ...
    private static final List<TextureLocalization> SEND_INV_BUTTON = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/senditems.png"), Component.translatable("justdirethings.screen.senditems"))
    );
    ...
    private static final List<TextureLocalization> PULL_INV_BUTTON = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/pullitems.png"), Component.translatable("justdirethings.screen.pullitems"))
    );
    ...
    private static final List<TextureLocalization> SWAP_INV_BUTTON = List.of(
            new TextureLocalization(Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/swapitems.png"), Component.translatable("justdirethings.screen.swapitems"))
    );
    ...
    private static final Identifier COPY_AREA_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/area.png");
    ...
    private static final Identifier COPY_OFFSET_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/stepheight.png");
    ...
    private static final Identifier COPY_FILTER_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/matchnbttrue.png");
    ...
    private static final Identifier COPY_REDSTONE_BUTTON = Identifier.fromNamespaceAndPath(JustDireThings.MODID, "textures/gui/buttons/redstonepulse.png");
