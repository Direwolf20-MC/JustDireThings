...
public class BlockSwapperT2Container extends BaseMachineContainer {
    ...
    public BlockSwapperT2Container(int windowId, Inventory playerInventory, BlockPos blockPos) {
        super(JDTRegistration.BlockSwapperT2_Container.get(), windowId, playerInventory, blockPos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTRegistration.BlockSwapperT2.get());
    }
