...
public class FluidCollectorT1Container extends BaseMachineContainer {
    ...
    public FluidCollectorT1Container(int windowId, Inventory playerInventory, BlockPos blockPos) {
        super(JDTRegistration.FluidCollectorT1_Container.get(), windowId, playerInventory, blockPos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTRegistration.FluidCollectorT1.get());
    }
