...
public class SensorT1Container extends BaseMachineContainer {
    ...
    public SensorT1Container(int windowId, Inventory playerInventory, BlockPos blockPos) {
        super(JDTRegistration.SensorT1_Container.get(), windowId, playerInventory, blockPos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTRegistration.SensorT1.get());
    }
