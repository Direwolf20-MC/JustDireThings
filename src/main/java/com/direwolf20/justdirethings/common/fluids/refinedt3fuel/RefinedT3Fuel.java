...
public abstract class RefinedT3Fuel extends BaseFlowingFluid implements RefinedFuel {
    public static final Properties PROPERTIES = new Properties(
            JDTRegistration.REFINED_T3_FLUID_TYPE,
            JDTRegistration.REFINED_T3_FLUID_FLOWING,
            JDTRegistration.REFINED_T3_FLUID_SOURCE
    ).bucket(JDTRegistration.REFINED_T3_FLUID_BUCKET).block(JDTRegistration.REFINED_T3_FLUID_BLOCK);
    ...
    public Fluid getFlowing() {
        return JDTRegistration.REFINED_T3_FLUID_FLOWING.get();
    }

    @Override
    public Fluid getSource() {
        return JDTRegistration.REFINED_T3_FLUID_SOURCE.get();
    }

    @Override
    public Item getBucket() {
        return JDTRegistration.REFINED_T3_FLUID_BUCKET.get();
    }
