...
public class EclipseAlloyShovel extends BaseShovel implements PoweredTool, GooTieredItem {
    public EclipseAlloyShovel(Item.Properties pProperties) {
        super(GooTier.ECLIPSEALLOY.material(), 1.5F, -3.0F, pProperties);
